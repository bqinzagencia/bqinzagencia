...
const INDUSTRIES = [
  { icon: '🔧', title: 'Talleres & Mecánica', desc: 'Agenda citas, historial de vehículos, presupuestos y seguimiento.', tag: 'Agendamiento IA' },
  { icon: '✂️', title: 'Peluquerías & Spa', desc: 'Reservas 24/7, recordatorios automáticos y portafolio de servicios.', tag: 'Reservas automáticas' },
  { icon: '🏠', title: 'Inmobiliarias', desc: 'Filtra leads, muestra propiedades y agenda visitas con IA.', tag: 'CRM inmobiliario' },
  { icon: '🍕', title: 'Restaurantes', desc: 'Pedidos por WhatsApp, reservas de mesas y seguimiento de domicilios.', tag: 'Pedidos IA' },
  { icon: '🛒', title: 'Tiendas & Retail', desc: 'Catálogo digital, asistente de ventas e inventario automático.', tag: 'Ventas automáticas' },
  { icon: '📋', title: 'Papelerías & Servicios', desc: 'Cotizaciones automáticas, seguimiento de pedidos y comunicación.', tag: 'Cotizaciones IA' },
  { icon: '🏋️', title: 'Gimnasios & Fitness', desc: 'Inscripciones, clases, recordatorios de pago y seguimiento.', tag: 'Gestión miembros' },
  { icon: '🏥', title: 'Salud & Clínicas', desc: 'Agenda médica, pre-triage por chat e historial del paciente.', tag: 'Citas médicas' },
];
      ...
      <section id="industrias" style={{ padding: '100px 60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 1, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 16, overflow: 'hidden' }}>
          {INDUSTRIES.map((ind, i) => (
            <div key={i} style={{ background: '#111318', padding: '28px', transition: 'background 0.2s', cursor: 'pointer' }}
              onMouseEnter={e => e.currentTarget.style.background='#1A1E26'}
