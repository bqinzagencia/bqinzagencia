...
const SERVICIOS = [
  { img: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=800&h=600&fit=crop&crop=faces,center&q=90', title: 'Centro de Estética', desc: 'Agente IA que gestiona citas de facial, depilación y tratamientos mientras tú trabajas con las manos ocupadas.', slug: 'estetica' },
  { img: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&h=600&fit=crop&crop=center&q=90', title: 'Salón de Belleza', desc: 'Reservas automáticas, recordatorios de cita y lista de espera gestionada por IA. Cero llamadas perdidas.', slug: 'salon' },
  { img: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&h=600&fit=crop&crop=center&q=90', title: 'Spa & Masajes', desc: 'Agenda inteligente para múltiples cabinas y terapeutas. El cliente reserva en WhatsApp en menos de 30 segundos.', slug: 'spa' },
  { img: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=800&h=600&fit=crop&crop=center&q=90', title: 'Clínica Dental', desc: 'Confirmaciones automáticas, recaptación de pacientes inactivos y gestión de urgencias con IA de voz.', slug: 'dental' },
  { img: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=800&h=600&fit=crop&crop=center&q=90', title: 'Medicina Estética', desc: 'Filtrado de pacientes, consentimientos digitales y seguimiento post-tratamiento automatizado.', slug: 'medicina-estetica' },
];
...
const PLANES = [
  {
    name: 'Starter', badge: 'Micropymes y salones', price: '89', priceAnual: '74',
    features: ['Agente WhatsApp IA 24/7','Hasta 500 conversaciones/mes','Recordatorios automáticos de cita','Sincronización Google Calendar','Catálogo de servicios con precios','Cobro de señales vía Bizum','Soporte por email en 48h'],
    nota: 'Bloque extra de 250 conversaciones por solo 10€/mes',
    cta: 'Comenzar ahora', popular: false, href: '/auth/register?plan=starter', ahorro: 'Ahorra 180€/año',
  },
  {
    name: 'Básico', badge: '⭐ Más recomendado', price: '199', priceAnual: '166',
    features: ['Todo en Starter','Hasta 1.500 conversaciones/mes','200 min/mes de Agente de Voz IA','Minuto de voz extra: 0,08€/min','Cobro de señales Stripe + Bizum','CRM de clientes completo','Panel analítico en tiempo real','Soporte prioritario en 4h'],
    nota: 'Bloque extra +500 conversaciones por 15€/mes',
    cta: 'Comenzar ahora', popular: true, href: '/auth/register?plan=basico', ahorro: 'Ahorra 396€/año',
  },
  {
    name: 'Pro', badge: 'Clínicas y franquicias', price: '569', priceAnual: '474',
    features: ['Todo en Básico','Conversaciones ilimitadas','Minutos de voz ilimitados','Hasta 5 centros en 1 cuenta','Integración Instagram DM','Consentimientos digitales RGPD','Integraciones Holded / FacturaDirecta','Manager de cuenta dedicado','SLA 99,9% garantizado'],
    nota: null,
    cta: 'Contactar con Ventas', popular: false, href: 'mailto:bqinzagencia@gmail.com?subject=Plan%20Pro%20-%20BQinzagencIA', ahorro: 'Ahorra 1.140€/año',
  },
];
...
export function LogoIcon({ size = 34 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="32" cy="32" r="30" stroke={NARANJA} strokeWidth="2.8" fill="none" style={{ filter: `drop-shadow(0 0 7px ${NARANJA})` }} />
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <div style={{ fontFamily: 'Syne,sans-serif', fontSize: size, fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1 }}>
        <span style={{ color: '#FFFFFF' }}>BQinz</span><span style={{ color: NARANJA }}>agenc</span><span style={{ color: '#FFFFFF' }}>IA</span>
      </div>
    </div>
  );
}
...
export function GoogleButton({ onClick, loading, text = 'Continuar con Google' }) {
  return (
    <button onClick={onClick} disabled={loading}
      style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, background: '#fff', border: '1px solid #dadce0', borderRadius: 100, padding: '11px 24px', fontSize: 14, fontWeight: 600, color: '#3c4043', cursor: loading ? 'not-allowed' : 'pointer', transition: 'box-shadow 0.2s', fontFamily: 'Roboto,sans-serif', opacity: loading ? 0.7 : 1 }}
...
export default function Landing() {
  ...
  const FEATURES_DETAIL = {
    'Cero llamadas perdidas': {
      ...
      demo: 'tel:+34674421919', demoLabel: '📞 Llamar ahora',
    },
    'WhatsApp 24/7': {
      ...
      demo: `https://wa.me/34674421919?text=Hola%2C+quiero+m%C3%A1s+informaci%C3%B3n`, demoLabel: '💬 Contactar por WhatsApp',
    },
    'Agenda sincronizada': {
      ...
      demo: '/auth/register', demoLabel: '→ Conectar mi agenda',
    },
    'Recordatorios automáticos': {
      ...
      demo: '/auth/register', demoLabel: '→ Activar recordatorios',
    },
    'Cobro de señales': {
      ...
      demo: '/auth/register', demoLabel: '→ Configurar cobro de señales',
    },
    'Panel de control': {
      ...
      demo: '/dashboard', demoLabel: '→ Ver mi panel',
    },
  };
  ...
  return (
    <>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, backdropFilter: 'blur(20px)', background: 'rgba(8,11,15,0.92)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="nav-inner" style={{ padding: '14px 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div className="nav-links-desktop">
            ...
            <Link href="/wasapbot"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(37,211,102,0.1)', border: '1px solid rgba(37,211,102,0.25)', color: '#25D366', borderRadius: 100, padding: '5px 14px', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
          ...
          <div className="nav-cta-desktop" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            {user ? (
              <Link href="/dashboard" style={{ background: NARANJA, color: '#fff', borderRadius: 100, padding: '9px 22px', fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>Ir al panel →</Link>
            ) : (
              <>
                <Link href="/auth/login" className="btn btn-ghost btn-sm">Ingresar</Link>
                <Link href="/auth/register" style={{ background: NARANJA, color: '#fff', borderRadius: 100, padding: '9px 22px', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>Comenzar</Link>
              </>
            )}
          </div>
          <button className="nav-hamburger" onClick={() => setMenuOpen(o => !o)} aria-label="Menú">{menuOpen ? '✕' : '☰'}</button>
        </div>
        {menuOpen && (
          <div style={{ background: 'rgba(8,11,15,0.98)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '20px 20px 28px', display: 'flex', flexDirection: 'column', gap: 4 }}>
            {['Servicios','Funciones','Precios','Cómo funciona'].map(item => (
              <a key={item} href={'#' + item.toLowerCase().replace(/\s/g,'-')} onClick={() => setMenuOpen(false)}
                style={{ color: '#D1D5DB', fontSize: 16, fontWeight: 500, padding: '12px 8px', borderBottom: '1px solid rgba(255,255,255,0.05)', textDecoration: 'none' }}>{item}</a>
            ))}
            <Link href="/wasapbot" onClick={() => setMenuOpen(false)} style={{ color: '#25D366', fontSize: 16, fontWeight: 700, padding: '12px 8px', borderBottom: '1px solid rgba(255,255,255,0.05)', textDecoration: 'none' }}>🤖 WasapBot</Link>
            <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
              {user ? (
                <Link href="/dashboard" onClick={() => setMenuOpen(false)} style={{ background: NARANJA, color: '#fff', borderRadius: 100, padding: '12px', fontWeight: 700, textDecoration: 'none', textAlign: 'center' }}>Ir al panel →</Link>
              ) : (
                <>
                  <Link href="/auth/login" className="btn btn-ghost" style={{ justifyContent: 'center' }} onClick={() => setMenuOpen(false)}>Ingresar</Link>
                  <Link href="/auth/register" onClick={() => setMenuOpen(false)} style={{ background: NARANJA, color: '#fff', borderRadius: 100, padding: '12px', fontWeight: 700, textDecoration: 'none', textAlign: 'center' }}>Comenzar</Link>
                </>
              )}
            </div>
          </div>
      ...
      {/* ── HERO ── */}
      <section style={{ position: 'relative', height: '100vh', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <div className="hero-content" style={{ position: 'relative', zIndex: 2, maxWidth: 1200 }}>
          ...
          <h1 style={{ fontFamily: 'Syne,sans-serif', fontSize: 'clamp(34px,6vw,82px)', fontWeight: 800, lineHeight: 1.04, letterSpacing: '-2px', maxWidth: 860, marginBottom: 22, color: '#FAFAF8' }}>
            Tu centro lleno.<br /><span style={{ color: NARANJA }}>Cero citas perdidas.</span><br />Sin tocar el teléfono.
          </h1>
          ...
          <div className="hero-btns" style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 52 }}>
            ...
            <a href="#funciones" className="btn btn-ghost btn-lg" style={{ borderColor: 'rgba(255,255,255,0.22)', color: '#fff', fontSize: 16 }}>Ver más →</a>
          </div>
          <div className="hero-stats">
            {[{valor:'-65%',label:'menos no-shows'},{valor:'24/7',label:'atención automática'},{valor:'+38%',label:'citas recuperadas'},{valor:'< 30s',label:'para agendar en WhatsApp'}].map((s,i) => (
              <div key={i}>
        ...
        <div style={{ position:'absolute', bottom:28, left:'50%', transform:'translateX(-50%)', display:'flex', flexDirection:'column', alignItems:'center', gap:6, color:'rgba(255,255,255,0.28)', fontSize:11 }}>
          <div style={{ width:1, height:40, background:'linear-gradient(to bottom, transparent, rgba(255,255,255,0.22))' }} />scroll
        </div>
      </section>
      ...
      <div style={{ padding:'16px 0', borderTop:'1px solid rgba(255,255,255,0.05)', borderBottom:'1px solid rgba(255,255,255,0.05)', overflow:'hidden', background:DARK }}>
        <div style={{ display:'flex', gap:52, animation:'marquee 28s linear infinite', whiteSpace:'nowrap' }}>
          {['Citas automáticas','WhatsApp IA 24/7','Cero llamadas perdidas','Cobro de señales','Recordatorios automáticos','Agenda sincronizada','Voz IA para llamadas','Menos no-shows','Clientes recurrentes','Panel en tiempo real'].flatMap(t=>[t,t]).map((t,i)=>(
      ...
      <section className="section-pad" style={{ background:CARD, textAlign:'center' }}>
        <div style={{ maxWidth:720, margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))', gap:16, maxWidth:640, margin:'0 auto' }}>
            {[{n:'68%',txt:'de clientes no deja mensaje si no contestan'},{n:'3.2x',txt:'más reservas con respuesta inmediata en WhatsApp'},{n:'8–12',txt:'llamadas perdidas al día en un centro mediano'}].map((item,i)=>(
      ...
      <section id="servicios" className="section-pad">
        ...
        <p style={{ color:'#9CA3AF', fontSize:17, maxWidth:520, lineHeight:1.6, marginBottom:48 }}>Flujos de IA preconfigurados para cada especialidad. Activo en menos de 24 horas.</p>
          ...
          {SERVICIOS.slice(0,3).map(({img,title,desc,slug},i)=>(
            <Link key={i} href={'/especialidades/'+slug} className="servicio-card">
              ...
              <div style={{ position:'absolute', bottom:0, left:0, right:0, padding:'20px 22px' }}>
                ...
                <span style={{ display:'inline-flex', alignItems:'center', gap:6, background:NARANJA, color:'#fff', fontSize:12, fontWeight:700, padding:'6px 14px', borderRadius:100 }}>Ver más →</span>
              </div>
            </Link>
          ))}
        </div>
      ...
      <section id="funciones" className="section-pad" style={{ background:CARD }}>
        <div className="features-header" style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', marginBottom:48, gap:20 }}>
          ...
          <Link href="/auth/register" style={{ background:NARANJA, color:'#fff', borderRadius:100, padding:'11px 26px', fontSize:14, fontWeight:700, textDecoration:'none', flexShrink:0 }}>Ver planes →</Link>
        </div>
          ...
          {FEATURES.map(({num,Icon,title,desc,featured,isNew},i)=>(
            isNew ? (
              <Link key={i} href="/generar-web"
                style={{ background:'linear-gradient(135deg, #0D1A0D 0%, #0A1A10 100%)', border:'1px solid rgba(34,197,94,0.35)', borderRadius:16, padding:26, transition:'all 0.25s', textDecoration:'none', color:'inherit', display:'block', boxShadow:'0 0 24px rgba(34,197,94,0.08)', position:'relative', overflow:'hidden' }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor='rgba(34,197,94,0.6)';e.currentTarget.style.transform='translateY(-3px)';}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='rgba(34,197,94,0.35)';e.currentTarget.style.transform='translateY(0)';}}>
              ...
              <div key={i} style={{ background:featured?NARANJA:DARK, border:`1px solid ${featured?NARANJA:'rgba(255,255,255,0.06)'}`, borderRadius:16, padding:26, transition:'all 0.25s', color:featured?'#fff':'inherit', cursor:'pointer' }}
                ...
                <div style={{ fontSize:10, fontWeight:700, letterSpacing:2, color:featured?'rgba(255,255,255,0.55)':'#6B7280', marginBottom:16, textTransform:'uppercase' }}>{num} — {featured?'CLAVE':'FUNCIÓN'}</div>
      ...
      <section id="cómo-funciona" className="section-pad" style={{ background:CARD }}>
        ...
        <div className="steps-grid" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:28 }}>
          {[
            {n:1,img:'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=80&h=80&fit=crop&crop=center&q=80',title:'Regístrate',desc:'Crea tu cuenta en 2 minutos. Acceso inmediato.'},
      ...
      <section id="precios" className="section-pad">
        ...
        <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:48, flexWrap:'wrap' }}>
          ...
          <button onClick={()=>setAnual(a=>!a)} style={{ width:52, height:28, borderRadius:100, background:anual?NARANJA:'#1A1E26', border:`2px solid ${anual?NARANJA:'rgba(255,255,255,0.15)'}`, cursor:'pointer', position:'relative', transition:'all 0.25s', flexShrink:0 }}>
        ...
        <div className="plans-grid" style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:20, alignItems:'start' }}>
          {PLANES.map((plan,i)=>(
            <div key={i} style={{ border:`1px solid ${plan.popular?NARANJA:'rgba(255,255,255,0.08)'}`, borderRadius:22, padding:'36px 30px', position:'relative', background:plan.popular?'#1C1410':CARD, boxShadow:plan.popular?`0 0 40px ${NARANJA_GLOW}`:'none' }}>
              <div style={{ display:'inline-block', background:plan.popular?NARANJA:'rgba(255,255,255,0.06)', color:plan.popular?'#fff':'#9CA3AF', fontSize:11, fontWeight:700, padding:'4px 14px', borderRadius:100, marginBottom:20, letterSpacing:0.5 }}>{plan.badge}</div>
              <div style={{ fontFamily:'Syne,sans-serif', fontSize:14, fontWeight:800, letterSpacing:1, textTransform:'uppercase', color:plan.popular?NARANJA:'#fff', marginBottom:12 }}>{plan.name}</div>
              <div style={{ marginBottom:8 }}>
                ...
                {anual&&plan.ahorro&&<div style={{ marginTop:6 }}><span style={{ background:'rgba(255,107,0,0.1)', color:NARANJA, fontSize:11, fontWeight:700, padding:'2px 10px', borderRadius:100, border:'1px solid rgba(255,107,0,0.25)' }}>{plan.ahorro}</span></div>}
              </div>
              ...
              {plan.nota && <p style={{ fontSize:11, color:'#6B7280', marginBottom:16, lineHeight:1.5, fontStyle:'italic' }}>* {plan.nota}</p>}
              <a href={plan.href}
                style={{ display:'block', textAlign:'center', borderRadius:100, padding:'14px 24px', fontWeight:700, fontSize:14, textDecoration:'none', background:plan.popular?NARANJA:'transparent', color:plan.popular?'#fff':'#9CA3AF', border:plan.popular?'none':'1px solid rgba(255,255,255,0.15)', boxShadow:plan.popular?`0 0 24px ${NARANJA_GLOW}`:'none', transition:'opacity 0.2s' }}
          ...
          {TESTIMONIALS.map((t,i)=>(
            <div key={i} style={{ background:DARK, border:'1px solid rgba(255,255,255,0.06)', borderRadius:16, padding:26 }}>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:12 }}>
                ...
                <div><div style={{ fontWeight:600, fontSize:14 }}>{t.name}</div><div style={{ color:'#6B7280', fontSize:12 }}>{t.role}</div></div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="section-pad" style={{ textAlign:'center' }}>
        ...
        <div style={{ display:'flex', flexWrap:'wrap', gap:10, justifyContent:'center' }}>
          {INTEGRATIONS.map((int,i)=>(
            <div key={i} style={{ background:CARD, border:'1px solid rgba(255,255,255,0.08)', borderRadius:100, padding:'8px 18px', fontSize:13, fontWeight:500, transition:'all 0.2s', cursor:'default', display:'inline-flex', alignItems:'center', gap:8 }}
              onMouseEnter={e=>{e.currentTarget.style.borderColor=NARANJA_BORDER;}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor='rgba(255,255,255,0.08)';}}>
              <img src={int.img} alt={int.label} style={{ width:18, height:18, objectFit:'contain', display:'block', borderRadius:3 }} />{int.label}
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="cta-section">
        ...
        <p style={{ color:'#9CA3AF', fontSize:'clamp(15px,2vw,18px)', marginBottom:40, position:'relative' }}>Activo en menos de 24h · Sin permanencia</p>
        <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap', position:'relative' }}>
          <Link href="/auth/register" style={{ background:NARANJA, color:'#fff', borderRadius:100, padding:'15px 36px', fontSize:17, fontWeight:800, textDecoration:'none', boxShadow:`0 0 32px ${NARANJA_GLOW}` }}>
            Activar mi agente IA →
          </Link>
          <a href={`https://wa.me/34674421919?text=Hola%2C+quiero+m%C3%A1s+informaci%C3%B3n+sobre+BQinzagencIA`} target="_blank" rel="noopener noreferrer"
            style={{ background:'#25D366', color:'#fff', borderRadius:100, padding:'15px 36px', fontSize:17, fontWeight:800, textDecoration:'none', display:'inline-flex', alignItems:'center', gap:8 }}>
      ...
      <footer className="footer-grid">
        <div className="footer-brand">
          <Logo size={18} />
          <p style={{ color:'#6B7280', fontSize:14, lineHeight:1.6, maxWidth:260, marginTop:14 }}>IA especializada en centros de estética y belleza en España. Cero citas perdidas.</p>
          <p style={{ marginTop:14, color:'#3A4150', fontSize:12 }}>📍 España · bqinzagencia@gmail.com · +34 674 421 919</p>
        </div>
        {[
          {title:'Producto',links:['Funciones','Precios','Integraciones','WasapBot','Changelog']},
              ...
              {col.links.map((link,j)=>(
                <li key={j} style={{ marginBottom:10 }}>
                  <a href="#" style={{ color:'#6B7280', fontSize:13, textDecoration:'none', transition:'color 0.2s' }}
                    onMouseEnter={e=>e.target.style.color=NARANJA} onMouseLeave={e=>e.target.style.color='#6B7280'}>{link}</a>
                </li>
              ))}
            </ul>
          </div>
      ...
      {featureModal && modalData && (
        <div onClick={()=>setFeatureModal(null)} style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.8)', zIndex:9990, display:'flex', alignItems:'center', justifyContent:'center', padding:20, backdropFilter:'blur(8px)' }}>
          <div onClick={e=>e.stopPropagation()} style={{ background:'#111318', border:`1px solid ${NARANJA_BORDER}`, borderRadius:24, padding:'36px 32px', maxWidth:520, width:'100%', position:'relative', boxShadow:`0 30px 80px rgba(0,0,0,0.7)` }}>
            <button onClick={()=>setFeatureModal(null)} style={{ position:'absolute', top:16, right:16, background:'rgba(255,255,255,0.06)', border:'none', color:'#9CA3AF', width:32, height:32, borderRadius:8, cursor:'pointer', fontSize:16, display:'flex', alignItems:'center', justifyContent:'center' }}>✕</button>
            <div style={{ width:52, height:52, borderRadius:14, background:NARANJA_GLOW, border:`1px solid ${NARANJA_BORDER}`, display:'flex', alignItems:'center', justifyContent:'center', marginBottom:20 }}>
            ...
            <div style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:14, padding:'16px 18px', marginBottom:16 }}>
              ...
              {modalData.como.map((item,i)=>(
                <div key={i} style={{ display:'flex', alignItems:'flex-start', gap:10, marginBottom:9, fontSize:13, color:'#D1D5DB' }}>
                  <span style={{ width:18, height:18, borderRadius:'50%', background:NARANJA_GLOW, border:`1px solid ${NARANJA_BORDER}`, color:NARANJA, fontSize:9, fontWeight:800, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, marginTop:1 }}>✓</span>{item}
                </div>
              ))}
            </div>
            ...
            <div style={{ display:'flex', gap:10 }}>
              <a href={modalData.demo} style={{ flex:1, background:NARANJA, color:'#fff', borderRadius:12, fontWeight:700, fontSize:14, padding:'12px', textDecoration:'none', textAlign:'center', display:'block' }}>{modalData.demoLabel}</a>
              <button onClick={()=>setFeatureModal(null)} style={{ background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)', color:'#9CA3AF', borderRadius:12, padding:'12px 16px', fontSize:14, cursor:'pointer' }}>Cerrar</button>
            </div>
          </div>
        </div>
      )}
