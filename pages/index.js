  ...
  return (
    <>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, backdropFilter: 'blur(20px)', background: 'rgba(8,11,15,0.92)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="nav-inner" style={{ padding: '14px 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div className="nav-links-desktop">
            ...
            <Link href="/wasapbot"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(37,211,102,0.1)', border: '1px solid rgba(37,211,102,0.25)', color: '#25D366', borderRadius: 100, padding: '5px 14px', fontSize: 13, fontWeight: 700, textDecoration: 'none', transition: 'all 0.2s' }}
        ...
        {menuOpen && (
          <div style={{ background: 'rgba(8,11,15,0.98)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '20px 20px 28px', display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <Link href="/wasapbot" onClick={() => setMenuOpen(false)}
              style={{ color: '#25D366', fontSize: 16, fontWeight: 700, padding: '12px 8px', borderBottom: '1px solid rgba(255,255,255,0.05)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
              🤖 WasapBot
            </Link>
      ...
      <section id="demo" className="section-pad" style={{ textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'Syne,sans-serif', fontSize: 'clamp(28px,4vw,52px)', fontWeight: 800, letterSpacing: '-1.5px', marginBottom: 16 }}></h2>
        ...
        <p style={{ color: '#9CA3AF', fontSize: 13, marginTop: 20 }}> · Activo en 24h</p>
      </section>
      ...
      <section id="cómo-funciona" className="section-pad" style={{ background: CARD }}>
        ...
        <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 28 }}>
          {[
        { n: 1, img: 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=80&h=80&fit=crop&crop=center&q=80', title: 'Regístrate', desc: 'Crea tu cuenta en 2 minutos. .' },
      ...
      <section className="cta-section">
        ...
        <p style={{ color: '#9CA3AF', fontSize: 'clamp(15px,2vw,18px)', marginBottom: 40, position: 'relative' }}> de crédito · Activo en menos de 24h</p>
